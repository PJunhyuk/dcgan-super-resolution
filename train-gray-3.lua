...
local netG = nn.Sequential()
-- nc x 32 x 32
netG:add(SpatialFullConvolution(nc, ngf * 8, 2, 2, 2, 2))
netG:add(SpatialBatchNormalization(ngf * 8)):add(nn.ReLU(true))
-- ngf*8 x 64 x 64
netG:add(SpatialFullConvolution(ngf * 8, ngf * 4, 2, 2, 2, 2))
netG:add(SpatialBatchNormalization(ngf * 4)):add(nn.ReLU(true))
-- ngf*4 x 128 x 128
netG:add(SpatialFullConvolution(ngf * 4, nc, 2, 2, 2, 2))
netG:add(SpatialBatchNormalization(nc)):add(nn.ReLU(true))
-- nc x 256 x 256
netG:add(nn.SpatialAveragePooling(2, 2, 2, 2, 0, 0))
netG:add(SpatialBatchNormalization(nc)):add(nn.ReLU(true))
-- nc x 128 x 128
netG:add(nn.SpatialAveragePooling(2, 2, 2, 2, 0, 0))
netG:add(nn.Sigmoid())
